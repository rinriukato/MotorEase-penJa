...
def runOCR():
    if __name__ == '__main__':
        ...
        input_path_img = '.../MIRACLE/code/src/ExpandingElements/combined/5_com.rtbishop.look4sat_Top_Down_80.png'
        output_root = '.../MIRACLE/code/src/ExpandingElements/OCRtxt'
