...
def objectDetect():
  ...
  from src.ExpandingElements.ImageDetection import utils
  ...
  os.chdir(".../MIRACLE/code/src/ExpandingElements/ImageDetection")
  ...
  print("================= INFERENCE ===========================")
  os.remove('.../MIRACLE/code/src/ExpandingElements/ImageDetection/inference_output/inferenceResults.json')
  with torch.no_grad():
      correct = 0
      total = 0
      inference_result = {}
      ...
      for i, (images, labels) in enumerate(data_loader_test, 0):
          ...
          inference_output_filename = '.../MIRACLE/code/src/ExpandingElements/ImageDetection/inference_output/inferenceResults.json'
          with open(inference_output_filename, "a") as fp:
  ...
  # write inference result
  # with open('./inference_result.json', 'a') as fp:
  #   json.dump(inference_result, fp)
