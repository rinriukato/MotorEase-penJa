...
import os
# get OCR files
ocr_files = [file for file in glob.glob(".../ocr/" + "*.json")] # provide location of the OCR files
ocr_files.sort()
# print(ocr_files)
os.remove(".../patternMatchingResults.txt")
writing = open(".../patternMatchingResults.txt", 'a')
