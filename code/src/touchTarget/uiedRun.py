...
def uied():
    ...
    '''
    onlyfiles = [f for f in listdir(".../MIRACLE/Data/touchScreens/screens/") if isfile(join(".../MIRACLE/Data/touchScreens/screens/", f))]
    print(len(onlyfiles))
    key_params = {'min-grad':10, 'ffl-block':5, 'min-ele-area':50,
                      'merge-contained-ele':True, 'merge-line-to-paragraph':False, 'remove-bar':True}
    count = 0 
    for files in onlyfiles:
        path = ".../MIRACLE/Data/touchScreens/screens/"
        fileLoc = path+files
        # print('-----------------------')
        # print(fileLoc)
        try:
            ...
            output_root = '.../MIRACLE/Data/touchScreens/Output'
